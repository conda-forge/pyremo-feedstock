...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyremo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15541&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyremo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyremo` can be installed with:

```
conda install pyremo
```

It is possible to list all of the versions of `pyremo` available on your platform with:
